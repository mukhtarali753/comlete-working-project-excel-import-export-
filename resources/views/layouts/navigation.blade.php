        ...
        <div class="flex justify-between h-16 items-center">
            <div class="flex">
                ...
                <div class="hidden sm:flex space-x-8 sm:-my-px sm:ml-10">
                    ...
                    <div class="hidden sm:flex space-x-8 sm:-my-px sm:ml-10">
                        <button style="color: black">
                            ...
                            <a href="{{ route('showboard') }}"
                                class="{{ request()->routeIs('showboard') ? 'active' : '' }}"> Board</a>
                    ...
                    {{-- <button>
                        <form action="{{ route('excel.preview.fixed') }}" method="GET">
                            <button type="submit">Preview excel Sheet</button>
                        </form>
                    </button> --}}
                    ...
                    {{-- <button>
                        <form action="{{ route('./table-preview') }}" method="GET">
                            <button type="submit">Preview excel Shop</button>
                        </form>
                    </button>  --}}
                ...
                {{-- <button>
                       ...
                       <a href="{{ route('shops.preview') }}">Shops</a>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <form action="{{ route('logout') }}" method="POST">
                    ...
                    {{-- <button style="color: black; background-color: gray; border: none; padding: 8px 16px;"
                        onclick="event.preventDefault(); this.closest('form').submit();">Logout</button> --}}
                    {{-- <button
                        style="color: white; background-color: black; border: 10px solid white; padding: 8px 16px;"
                        onclick="event.preventDefault(); this.closest('form').submit();">Logout</button> --}}
                    <button
